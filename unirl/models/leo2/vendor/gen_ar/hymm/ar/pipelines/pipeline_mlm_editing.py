...
from ..mask_schedulers import adap_sche, create_attention_mask_general
...
class EditingMLMPipeline(MaskedImageModelingPipeline):
    def __init__(self,
                 vae,
                 model,
    ...
    def __call__(
        ...
        **kwargs,
        ...
        whole_tokens, uncond_whole_tokens = self.prepare_instruction_tuning_whole_tokens(
            repeat_interleave([(p,) for p in prompt], num_sample_per_prompt),
            src_shifted_tokens,
            masked_tokens,
            image_token_len,
        ...
        # 6.  Create attention mask: [bs*2, 1, seqlen, seqlen]
