...
@dataclass
class Text2SiglipTransfusionPipelineOutput(BaseOutput):
    latents: Union[List[Any], torch.Tensor]
...
class Text2SiglipTransfusionPipeline(DiffusionPipeline):
    r"""
    ...
    def __init__(
        ...
        self.vision_encoder_latent_dim = self.args.vision_encoder_latent_dim
    ...
    def prepare_latents(self, batch_size, latent_channel, dtype, device, generator, latents=None):
        latents_shape = (
            batch_size,
            self.vision_encoder_max_num_patches,
            latent_channel,
        )
    ...
    def __call__(
        ...
        **kwargs,
        ...
        latent_channel = self.args.vision_encoder_latent_dim
        if hasattr(self.args, "compression_net_type"):
            from hymm.models.visual_encoders.siglip2.compression import CompressionNet
            latent_channel = CompressionNet.config[self.args.compression_net_type]["out_channels"]
        ...
        return Text2SiglipTransfusionPipelineOutput(latents=latents)
