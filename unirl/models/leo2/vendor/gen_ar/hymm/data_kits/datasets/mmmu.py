...
class MMMUDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_path = sample.pop('image').convert('RGB')
        image, _ = ArrowIndexV2.resize_and_pad(
            image_path, self.target_size, resample=Image.Resampling.BICUBIC, pad_color=self.pad_color,
        )
        ...
        line = {
            ...
            **(
            ...
            # Above are used for evaluation. Below are used for visualization.
