...
from .common_modules import ResnetBlock, AttnBlock, Downsample, Upsample, Normalize, nonlinearity
...
class MAGVITv2(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        self.codebook_size = 2 ** 13
        self.downsample_factor = 2 ** (self.encoder.num_resolutions - 1)
    ...
    def vq_encode(self, pixel_values):
        return self.get_code(pixel_values)

    def vq_decode(self, codebook_indices, shape=None):
        return self.decode_code(codebook_indices, shape=shape)
