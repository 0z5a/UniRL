...
if __name__ == "__main__":
    ...
    # Image.open("assets/images/1.webp"), 
    img_prefix = "/apdcephfs_nj10/share_301739632/yutaocui/workspace/data_processing/rl_data_proc/assets/images"
    pil_images = [Image.open(os.path.join(img_prefix, f"{i}.webp")) for i in range(1, 5)]
...
# PYTHONPATH=./ python3 hymm/models/reward_models/pick_score.py
