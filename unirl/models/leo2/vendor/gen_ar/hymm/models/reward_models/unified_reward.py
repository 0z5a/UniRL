...
if __name__ == "__main__":
    ...
    parser.add_argument("--api_url", type=str, default="http://29.162.246.83:8080")
    ...
    images = [
        Image.open(os.path.join(img_prefix, f"{i}.webp")).convert("RGB")
        for i in range(1, 5)
    ] * 4
    prompts = "a painting of an ocean with clouds and birds, day time, low depth field effect"
...
"""
PYTHONPATH=./ python3 hymm/models/reward_models/unified_reward.py --api_url http://29.162.246.83:8080 --max_workers 8
"""
