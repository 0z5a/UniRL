...
class HunYuanModel(HunYuanPreTrainedModel):
    ...
    def forward(
        ...
        if attention_mask is not None:
            ...
            # Keep it as None, as a full attention in SDPA.
            pass
        ...
        if use_ext_model_:
            outputs = ext_model_forward(hidden_states, position_ids, attention_mask, custom_pos_emb, first_step)
