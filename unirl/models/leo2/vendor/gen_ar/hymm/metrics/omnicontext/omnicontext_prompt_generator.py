...
if __name__ == '__main__':
    p = PromptGenerator()
    # print(p('test', task_type='prompt_following'))
    # print(p('test', task_type='subject_consistency', with_scene=False))
    print(p('test', task_type='subject_consistency', with_scene=True))
