...
class PNet(nn.Module):
    ...
    def __init__(self, pretrained=True, state_dict_path=None):
        ...
        if pretrained:
            state_dict_path = os.path.join(state_dict_path, 'facenet_pytorch/data/pnet.pt')
...
class RNet(nn.Module):
    ...
    def __init__(self, pretrained=True, state_dict_path=None):
        ...
        if pretrained:
            state_dict_path = os.path.join(state_dict_path, 'facenet_pytorch/data/rnet.pt')
            state_dict = torch.load(state_dict_path)
            self.load_state_dict(state_dict)
...
class ONet(nn.Module):
    ...
    def __init__(self, pretrained=True, state_dict_path=None):
        ...
        if pretrained:
            state_dict_path = os.path.join(state_dict_path, 'facenet_pytorch/data/onet.pt')
            state_dict = torch.load(state_dict_path)
            self.load_state_dict(state_dict)
...
class MTCNN(nn.Module):
    ...
    def __init__(
        ...
        self.pnet = PNet(state_dict_path=state_dict_path)
        self.rnet = RNet(state_dict_path=state_dict_path)
        self.onet = ONet(state_dict_path=state_dict_path)
