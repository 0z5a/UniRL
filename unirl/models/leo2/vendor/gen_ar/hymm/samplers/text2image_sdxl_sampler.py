...
class Text2ImageSDXLSampler(BaseSampler):
    def __init__(self, args, model_dict, ckpt_path=None, rank=0, world_size=1, device=0, logger=None):
        ...
        path = "/apdcephfs_sh7/share_301124792/chenyangqi/pretrained_ckpt/stable-diffusion-xl-base-1.0"
 ...
 num_sample_per_prompt: {num_sample_per_prompt}
      ...
      logits_processor: {logits_processor_repr}"""
        ...
        samples = self.pipeline(prompt, output_type="pt").images[0] # torch tensor c h w in 0,1
...
def main():
    ...
    sampler = Text2ImageSDXLSampler.from_pretrained(
