# Copied from https://github.com/deepseek-ai/Janus/blob/main/janus/models/image_processing_vlm.py
...
def load_pil_images(images_path: List[str]) -> List[PIL.Image.Image]:
    """
    Support file path.
    Returns:
