...
save_path=/apdcephfs_cq8/share_2938211/kevinkhwu/tmp/offline_infer
pp_size=1
ep_size=8
...
--sample-batch-size 1 --sample-image-size $image_resolution --guidance-scale 6.0 --diff-infer-steps 40 --skip-exist \
