...
# import transformer_engine.pytorch   # Trigger transformer_engine_torch loading
# from transformer_engine_torch import DType as TE_DType

class TE_DType:
    kFloat8E5M2 = 'asdfasdfasdf'
    kFloat8E4M3 = 'asdfasdfasdf'
    ...
    def backward(ctx, unpermuted_act_grad):
        ...
        if ctx.needs_input_grad[0]:
            ...
            if ctx.with_probs:
                ...
                act_grad, _ = permute_with_mask_map(
                    unpermuted_act_grad,
                    row_id_map,
                    None,
                    ctx.num_tokens,
...
def _unpermute_kernel(
    ...
    if FP8_DTYPE == "e5m2":
        ...
        tl.static_assert(FP8_DTYPE is None, "FP8_DTYPE must be None")
    ...
    while current_start < hidden_size:
        ...
        for expert_idx in range(num_experts):
            ...
            # TODO: debug
            # tl.device_print("after tl.load src_row", src_row)
            ...
            if src_row != -1:
                ...
                # TODO: debug
                # tl.device_print("after tl.load inp when src_row != -1", inp)
            ...
            # TODO: debug
            # tl.device_print("after a inner loop", expert_idx)
        ...
        # TODO: debug
        # tl.device_print("after tl.store output_ptr + output_off, current_start:", current_start)
