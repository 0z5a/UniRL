...
# PYTHONPATH=`pwd` torchrun --nproc_per_node=8 hy_parallelism/moe/gemini_moe.py
from typing import *
import os
...
def moe_ep_forward(experts, hidden_states, topk_idx, topk_weight, num_experts, ep_size, ep_group, fused_experts=False):
    ...
    from hy_parallelism.moe.moe_parallel import preprocess, token_pre_all2all, tokens_post_all2all
...
def main():
    ...
    def sd_transform_test():
        from hy_parallelism.moe import ckpt_utils
