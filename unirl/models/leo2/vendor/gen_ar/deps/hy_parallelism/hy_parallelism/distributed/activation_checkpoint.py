...
def _apply_layer_sac(module: nn.Module, ac_config: ActivationCheckpointConfig) -> nn.Module:
    ...
    Args:
        ...
        ac_config (ActivationCheckpointConfig): The activation checkpointing config.
...
def _apply_full_ac(module: nn.Module, ac_config: ActivationCheckpointConfig) -> nn.Module:
